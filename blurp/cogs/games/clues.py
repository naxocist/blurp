...
from blurp.services.mal import get_user_anime_list
...
class AniClues(commands.Cog):
    ...
    async def init(self, ctx: ApplicationContext, mal_username: str):
        ...
        registry.bind(ctx.author, clue_obj)
